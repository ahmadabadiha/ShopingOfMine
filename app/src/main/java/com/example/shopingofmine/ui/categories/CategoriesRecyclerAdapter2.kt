...
class CategoriesRecyclerAdapter2(private val onClick: (String) -> Unit, private val groupedCategories: Map<Int, List<CategoryItem>>) :
    ListAdapter<CategoryItem, CategoriesRecyclerAdapter2.CategoryViewHolder>(CategoryDiffCallback2()) {
    ...
    inner class CategoryViewHolder(private val binding: SubCategoryLayoutBinding) :
        ...
        fun fill(item: CategoryItem) {
            ...
            binding.apply {
                ...
                val categoriesRecyclerAdapter = CategoriesRecyclerAdapter(onClick)
